            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                            ...
                            <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                <tr>
                                    ...
                                    <td class="text-center"><span
                                            class="badge bg-secondary"><?php echo $row['status']; ?></span></td>
                                    <td class="text-center">
                                        <?php if (!empty($row['codigo_acompanhamento'])): ?>
                                            <code class="fs-6"
                                                id="codigo-<?php echo $row['id_os']; ?>"><?php echo htmlspecialchars($row['codigo_acompanhamento']); ?></code>
                                    ...
                                    <td class="text-center pe-3">
                                        <form method="POST" action="gerar_codigo.php" class="d-inline"
                                            ...
                                            <button type="submit"
                                                class="btn btn-sm <?php echo !empty($row['codigo_acompanhamento']) ? 'btn-outline-success' : 'btn-success'; ?> fw-bold">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="6" class="text-center text-muted py-4">Nenhuma Ordem de Serviço encontrada.
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
