...
<style> /* Cria um efeito suave de elevação quando o mouse passa sobre os cards */
    .card-hover {
...
<div class="container mt-4 mb-5"> <!-- Centraliza o conteúdo com margens em cima e embaixo. -->
    
    <div class="d-flex justify-content-between align-items-center mb-4"> <!-- Deixa o título e a data um do lado do outro, alinhados no centro verticalmente. -->
    ...
    <div class="alert alert-success border-0 shadow-sm border-start border-4 border-success mb-4" role="alert"> <!-- Caixa de boas-vindas verde, com sombra -->
    ...
    <div class="row g-4"> <!-- Cria uma grade responsiva com espaçamento bom entre os cards -->
        <div class="col-md-4"> <!-- Cada card ocupa 1/3 da tela em telas médias/grandes -->
            <a href="/mindtech/usuarios/listar.php" class="text-decoration-none"> <!-- "text-decoration-none" Remove o sublinhado dos links -->
                <div class="card h-100 border-0 shadow-sm border-start border-4 border-primary card-hover"> <!-- Cards com altura igual, sem borda completa, 
                                                                                                                 sombra leve e uma borda colorida.
                                                                                                                 E com efeito de hover (animação) nos cards -->
                    <div class="card-body d-flex align-items-center justify-content-between"> 
                        <div>
                            <h5 class="mb-0 fw-bold text-dark">Usuários</h5>
                            <small class="text-muted">Acessos do sistema</small> 
                        </div>
                        <i class="bi bi-people-fill fs-1 text-primary opacity-50"></i> <!-- Ícones grandes do Bootstrap Icons, coloridos e com leve transparência -->
                    </div>
                </div>
            </a>
        </div>
