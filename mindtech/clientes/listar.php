...
<div class="container mt-4 mb-5">   <!-- Centraliza o conteúdo com espaçamento em cima e embaixo -->
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">   <!-- Título e botões alinhados lado a lado -->
        <h1>Meus Clientes</h1>
        <div>
    ...
    <div class="card shadow-sm border-0 border-start border-4 border-success">   <!-- Card com sombra suave e borda verde grossa do lado esquerdo -->
        <div class="card-body p-0">
            
            <table class="table table-hover table-striped align-middle mb-0">   <!-- Tabela com listras alternadas e efeito hover ao passar o mouse -->
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo $cliente['telefone'] != '' ? $cliente['telefone'] : '-'; ?>
                                </td>
                                <td class="text-center pe-3">
                                    <!-- Botão pequeno verde com apenas borda -->
