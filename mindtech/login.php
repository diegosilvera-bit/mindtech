...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css" rel="stylesheet">   <!-- Bootstrap: Importando o CSS oficial -->
...
<body>
<div class="container">   <!-- Bootstrap: Container principal -->
        ...
        <div class="col-md-4">   <!-- Bootstrap: Coluna responsiva (4 de 12 colunas em telas médias/grandes) -->
            ...
            <div class="card shadow">   <!-- Bootstrap: Card com sombra padrão -->
                <div class="card-body">   <!-- Bootstrap: Corpo do card (área interna) -->
                    ...
                    <?php if ($erro): ?>
                        <div class="alert alert-danger"><?= $erro ?></div>   <!-- Bootstrap: Alerta vermelho de erro -->
                    <?php endif; ?>
                    
                    <form method="post">
                        <input class="form-control mb-3" name="login" placeholder="Login" required>   <!-- Bootstrap: Campo estilizado + margem inferior -->
                        <input class="form-control mb-3" type="password" name="senha" placeholder="Senha" required>   <!-- Bootstrap: Campo de senha + margem inferior -->
                        <button class="btn btn-primary w-100">Entrar</button>   <!-- Bootstrap: Botão primário ocupando 100% da largura -->
                    </form>
                    
                    <p class="small text-muted mt-3">admin / admin</p>   <!-- Bootstrap: Texto pequeno + margem superior -->
