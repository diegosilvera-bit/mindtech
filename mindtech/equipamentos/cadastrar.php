...
<div class="container mt-4 mb-5"> <!-- Centraliza o conteúdo com espaçamento em cima e embaixo. -->
    ...
    <div class="card shadow-sm border-0 border-start border-4 border-info"> <!-- Card principal com sombra leve, sem borda completa e uma borda grossa azul -->
        <div class="card-body p-4"> <!-- Ajustamento dos campos -->
            ...
            <form method="post" action="">
                ...
                <div class="row"> 
                    ...
                    <!-- (row + col-md-4 / col-md-8) Organiza os campos em linhas e colunas, responsivo (ajusta no celular). -->
                        <label class="form-label fw-bold">ID do Cliente (Dono) *</label> 
                        <!-- (form-label) Caixas de texto com estilo padrão bonito do Bootstrap. -->
                        <!-- (fw-bold) Labels (nomes dos campos) em negrito.. -->
                    ...
                    <div class="col-md-8 mb-3"> <!-- Espaçamento bom entre os campos. -->
                ...
                <hr class="mt-4">
                <div class="d-flex justify-content-end gap-2"> <!-- Botões "Cancelar" e "Salvar" alinhados à direita, com espaçamento entre eles. -->
                    ...
                    <!-- (btn btn-light border e btn btn-info text-white)
                    Botões com estilos diferentes: um claro (cancelar) e um azul forte (salvar). -->
                </div>
